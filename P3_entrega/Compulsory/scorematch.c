...
void get_books(char* title, int *numResults){
    ...
    /*As this is an optional part, we decided not to include this index 
    on the other parts, so we need to create the index each time the program
    is initialiced in order to make sure it is updated*/
